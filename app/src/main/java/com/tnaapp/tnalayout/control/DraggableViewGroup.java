...
//            mMediaController.setVisibility(INVISIBLE);
            ...
            mHeaderView.setPivotX(mHeaderView.getWidth() - floatPlayerRightMargin);
            mHeaderView.setPivotY(mHeaderView.getHeight() - floatPlayerBottomMargin);
            //thu nhỏ trình player
            mHeaderView.setScaleX(1 - mDragOffset / 1.9f);
            mHeaderView.setScaleY(1 - mDragOffset / 2.1f);
...
//    }
    ...
    private int floatPlayerBottomMargin = getResources().getDimensionPixelSize(R.dimen.float_player_bottom_margin);

    private int floatPlayerRightMargin = getResources().getDimensionPixelSize(R.dimen.float_player_right_margin);
